...
class Rotation_vector_handler:
    """Rotation_vector_handler Rotation:
    Class to represent 3D rotations via Rotation_vector_handlers.
    """
    @classmethod
    def create_rot_v_theta(cls, v, theta):
        """
        Construct Rotation_vector_handlers from unit vectors v and rotation angles theta
        Parameters
        ----------
        v : array_like
        ...
        Returns
        -------
        q : Rotation_vector_handler object
            Rotation_vector_handler representing the rotations
        """
    ...
    def __repr__(self):
        return "Rotation_vector_handler:\n" + self.x.__repr__()

    def __mul__(self, other):
        # multiplication of two Rotation_vector_handlers.
    ...
    def as_v_theta(self):
        """Return the v, theta equivalent of the (normalized) Rotation_vector_handler"""
    ...
    def as_rotation_matrix(self):
        """Return the rotation matrix of the (normalized) Rotation_vector_handler"""
...
def project_points(points, q, view, vertical=[0, 1, 0]):
    """Project points using a Rotation_vector_handler q and a view v
    Parameters
    ----------
    points : array_like
        array of last-dimension 3
    q : Rotation_vector_handler
        Rotation_vector_handler representation of the rotation
    view : array_like
